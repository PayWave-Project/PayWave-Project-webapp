        ...
        <div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-slate-200 dark:bg-gray-800 flex justify-between items-center text-primary lg:py-10 lg:px-8 p-4 rounded-lg shadow">
             <div>
             <h3 className="text-[16px] font-medium dark:text-white/50  mb-1">Total Deposits</h3>
              <p className="text-2xl font-bold text-nowrap break-words dark:text-white">₦23,958.00</p>
             </div>
              <div>
            ...
            <div className="bg-slate-200 dark:bg-gray-800 flex justify-between items-center text-primary lg:py-10 lg:px-8 p-4 rounded-lg shadow">
             <div>
             <h3 className="text-[16px] font-medium dark:text-white/50 mb-1">Total Withdrawal</h3>
              <p className="text-2xl font-bold text-nowrap break-words dark:text-white">₦999,958.00</p>
             </div>
              <div>
